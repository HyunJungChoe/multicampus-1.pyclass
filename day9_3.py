...
# checkPwd('abcdhgj000') => 비밀번호 완료

# re.findall(패턴식, 대상문자열) => [....] / []
# False의 조건 - [], (), {}, False, 0, ''
...
def checkPwd(pwd):
    if 6 <= len(pwd) <= 12:
        ...
        # result = re.findall('[\w]', pwd) # 한글+영어대소문자+숫자
        # print(result)
...
'''
 abcd-비밀번호 길이가 적당하지 않다.
 abcdhgj000-비밀번호 생성 완료
 ab강아지j000-영어대소문자와 숫자만가능
 a@bcj0-0-영어대소문자와 숫자만가능
 12   35 ***    789-비밀번호 길이가 적당하지 않다.
 a가나다라마-영어대소문자와 숫자만가능
 wordpython0000000-비밀번호 길이가 적당하지 않다.
'''
...
# [문자열]{n}
# 0이 2번나오고 영어대문자
print(re.findall('[0]{2}[a-zA-Z]+', str)) # ['00ab', '00cd', '00python']
print(re.findall('[0]{3}[a-zA-Z]+', str)) # ['000cd', '000python']
print(re.findall('[0]{4}[a-zA-Z]+', str)) # ['0000python']
print(re.findall('[0]{4}[a-zA-Z가-힣]+', str)) # ['0000python', '0000가나다']

# {n,} n번 이상 반복됨
print(re.findall('[0]{1,}[a-zA-Z가-힣]+', str))
# ['00ab', '000cd', '00000python', '0000가나다', '0도레미']

# {n, m} n~m 이상 반복됨
print(re.findall('[0]{2,4}[a-zA-Z가-힣]+', str))
# ['00ab', '000cd', '0000python', '0000가나다']
...
print('-'*50)
# 리스트반환
print(re.findall(pat1, '783689-8494736')) # ['783689-8494736']
print(re.findall(pat1, '89-8494736')) # []
print(re.findall(pat1, '7!!89-8494736')) # []
print(re.findall(pat1, '가나다123-8494736')) # []
print(re.findall(pat1, '783689-866494736')) # ['783689-8664947']
print(re.findall(pat1, '99783689-8494736')) # ['783689-8494736']

# re.search(패턴식, 대상문자열) => match 오브젝트
# re.match(패턴식, 대상문자열) => match 오브젝트
print(re.search(pat1, '783689-8494736'))
# <re.Match object; span=(0, 14), match='783689-8494736'>
print(re.search(pat1, '89-8494736')) # None
print(re.search(pat1, '783689-866494736'))
# <re.Match object; span=(0, 14), match='783689-8664947'>
print(re.search(pat1, '783689-866494736').group())
...
quiz1List = ['가나', '라일락', '가지', '망아지', '강아지',
             '국화', '가로수', '도라지', '화수분']
result =[]
for item in quiz1List:
  if re.findall('[가.]', item) :
    result.append(item)
print(result)
...
quiz2List = ['가나', '라일락', '가지', '망아지', '강아지',
             '국화', '가로수', '도라지', '화수분']
result =[]
for item in quiz2List:
  if re.findall('[$지]', item) :
    result.append(item)
print(result)
